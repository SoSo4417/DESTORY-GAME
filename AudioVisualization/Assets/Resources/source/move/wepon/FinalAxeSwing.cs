...
public class FinalAxeSwing : MonoBehaviour
{
    ...
    void Swing()
    {
        ...
        GameObject imp = Instantiate(impact, this.transform.position, this.transform.parent.rotation) as GameObject;
        Destroy(imp, lifetime);// 飛ばしたのは寿命がある
        imp.GetComponent<Flying>().Go();
